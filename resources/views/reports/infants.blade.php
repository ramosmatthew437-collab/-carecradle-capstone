        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6 sm:space-y-8">
            ...
            <div class="flex flex-col gap-4 rounded-2xl border border-gray-200 bg-white px-5 py-5 sm:flex-row sm:items-center sm:justify-between sm:px-7 sm:py-6 shadow-sm no-print">
                ...
                <div class="flex items-center gap-4">
                    ...
                    <div class="min-w-0">
                        ...
                        <h1 class="mt-0.5 text-lg sm:text-2xl font-bold text-gray-900">Infant Report</h1>
                        <p class="mt-1 text-sm text-gray-500">
                            Review infant healthcare records and newborn registration statistics.
                        </p>
                    </div>
                </div>
            ...
            <div class="no-print">
                ...
                <div class="mb-4 sm:mb-5">
                    <h2 class="text-lg sm:text-xl font-bold text-gray-900">Infant Healthcare Overview</h2>
                    <p class="mt-1 text-sm text-gray-500">Summary of registered infant records within the current report.</p>
                </div>
                ...
                <div class="grid grid-cols-1 gap-3 sm:grid-cols-3 sm:gap-4">
                    ...
                    <div class="rounded-2xl border border-gray-200 bg-white p-5 shadow-sm">
                        ...
                        <h3 class="mt-3 text-2xl sm:text-3xl font-bold text-gray-900">{{ $totalInfants }}</h3>
                        <p class="mt-1 text-xs sm:text-sm text-gray-500">Total Infants</p>
                    </div>
                    ...
                    <div class="rounded-2xl border border-gray-200 bg-white p-5 shadow-sm">
                        ...
                        <h3 class="mt-3 text-2xl sm:text-3xl font-bold text-blue-600">{{ $male }}</h3>
                        <p class="mt-1 text-xs sm:text-sm text-gray-500">Male Infants</p>
                    </div>
                    ...
                    <div class="rounded-2xl border border-gray-200 bg-white p-5 shadow-sm">
                        ...
                        <h3 class="mt-3 text-2xl sm:text-3xl font-bold text-pink-600">{{ $female }}</h3>
                        <p class="mt-1 text-xs sm:text-sm text-gray-500">Female Infants</p>
                    </div>
            ...
            <div class="overflow-hidden rounded-2xl border border-gray-200 bg-white shadow-sm no-print">
                ...
                <div class="border-b border-gray-200 bg-gray-50 px-5 py-4 sm:px-6 sm:py-5">
                    <div class="flex items-center gap-3">
                        ...
                        <div class="min-w-0">
                            <h2 class="text-base sm:text-lg font-semibold text-gray-900">Search &amp; Filter Infants</h2>
                            <p class="text-sm text-gray-500">Search infant healthcare records and narrow the report using infant sex.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="p-5 sm:p-6">
                    ...
                    <form method="GET" action="{{ route('reports.infants') }}" class="space-y-5">

                        <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">

                            <div class="sm:col-span-2">
                                <label class="mb-2 block text-sm font-medium text-gray-700">Search Infant</label>
                                <div class="relative">
                            ...
                            <div>
                                <label class="mb-2 block text-sm font-medium text-gray-700">Infant Sex</label>
                                <select
                                    name="sex"
            ...
            <div class="no-print">
                <div class="flex flex-col gap-4 rounded-2xl border border-gray-200 bg-white p-5 sm:p-6 shadow-sm lg:flex-row lg:items-center lg:justify-between">
                    ...
                    <div>
                        ...
                        <p class="mt-1 text-sm text-gray-500">
                            Showing <span class="font-semibold text-pink-600">{{ $infants->count() }}</span> registered infant record(s) based on the current search and filters.
                        </p>
                    </div>
            ...
            <div class="overflow-hidden rounded-2xl border border-gray-200 bg-white shadow-sm">
                ...
                <div class="border-b border-gray-200 bg-gray-50 px-5 py-4 sm:px-6 sm:py-5">
                    <div class="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
                        <div>
                            <h2 class="text-base sm:text-lg font-semibold text-gray-900">Infant Report</h2>
                            <p class="mt-1 text-sm text-gray-500">
                        ...
                        <div class="w-fit rounded-xl border border-gray-200 bg-white px-4 py-2 shadow-sm">
                            ...
                            <p class="mt-0.5 text-lg font-bold text-pink-600">{{ $infants->count() }}</p>
                        </div>
                    </div>
                </div>
                        ...
                        <table class="min-w-full divide-y divide-gray-200">
                            <thead class="bg-gray-50">
                                <tr>
                                    ...
                                    <th class="px-6 py-4 text-left text-xs font-semibold uppercase tracking-wider text-gray-600">Infant ID</th>
                                    <th class="px-6 py-4 text-left text-xs font-semibold uppercase tracking-wider text-gray-600">Infant Name</th>
                                    <th class="px-6 py-4 text-left text-xs font-semibold uppercase tracking-wider text-gray-600">Mother</th>
                                    <th class="px-6 py-4 text-center text-xs font-semibold uppercase tracking-wider text-gray-600">Sex</th>
                                    <th class="px-6 py-4 text-left text-xs font-semibold uppercase tracking-wider text-gray-600">Birth Date</th>
                                    <th class="px-6 py-4 text-center text-xs font-semibold uppercase tracking-wider text-gray-600">Birth Status</th>
                                </tr>
                            </thead>
                            <tbody class="divide-y divide-gray-200 bg-white">
                                @foreach($infants as $infant)
                                    ...
                                    <tr class="transition duration-150 hover:bg-pink-50/40">
                                        ...
                                        <td class="px-6 py-5">
                                            <span class="inline-flex rounded-lg bg-gray-100 px-3 py-1.5 font-mono text-xs font-semibold text-gray-700">{{ $infant->id }}</span>
                                        </td>
                                        <td class="px-6 py-5">
                                            <div class="flex items-center gap-3">
                                                ...
                                                <div>
                                                    <p class="font-semibold text-gray-900">{{ $infant->first_name }} {{ $infant->middle_name }} {{ $infant->last_name }}</p>
                                                    <p class="text-xs text-gray-500">Infant Patient</p>
                                                </div>
                                            </div>
                                        </td>
                                        <td class="px-6 py-5">
                                            <p class="font-medium text-gray-900">{{ $infant->mother->first_name }} {{ $infant->mother->last_name }}</p>
                                            <p class="text-xs text-gray-500">Mother</p>
                                        </td>
                                        <td class="px-6 py-5 text-center">
                                            <span class="inline-flex rounded-full px-3 py-1.5 text-xs font-semibold {{ $sexClass }}">{{ $infant->sex }}</span>
                                        </td>
                                        <td class="px-6 py-5 text-sm text-gray-700">{{ \Carbon\Carbon::parse($infant->birth_date)->format('M d, Y') }}</td>
                                        <td class="px-6 py-5 text-center">
                                            <span class="inline-flex rounded-full px-3 py-1.5 text-xs font-semibold {{ $birthStatusClass }}">{{ $infant->birth_status }}</span>
                                        </td>
                                    </tr>
                            ...
                            <div class="p-4 sm:p-5">
                                <div class="flex items-start justify-between gap-3">
                                    <div class="flex items-start gap-3 min-w-0">
                                        ...
                                        <div class="min-w-0">
                                            <p class="font-semibold text-gray-900 truncate">{{ $infant->first_name }} {{ $infant->middle_name }} {{ $infant->last_name }}</p>
                                            <p class="text-xs text-gray-500">#{{ $loop->iteration }} · Mother: {{ $infant->mother->first_name }} {{ $infant->mother->last_name }}</p>
                                        </div>
                                    </div>
                                    <div class="flex flex-shrink-0 flex-col items-end gap-1">
                                        <span class="inline-flex rounded-full px-2.5 py-0.5 text-[11px] font-semibold {{ $sexClass }}">{{ $infant->sex }}</span>
                                        <span class="inline-flex rounded-full px-2.5 py-0.5 text-[11px] font-semibold {{ $birthStatusClass }}">{{ $infant->birth_status }}</span>
                                    </div>
                                </div>

                                <div class="mt-3 grid grid-cols-2 gap-3 rounded-xl bg-gray-50 p-3 text-sm">
                                    <div>
                                        <p class="text-xs text-gray-400">Infant ID</p>
                                        <p class="text-gray-700 font-mono font-medium truncate">{{ $infant->id }}</p>
                                    </div>
                                    <div>
                                        <p class="text-xs text-gray-400">Birth Date</p>
                                        <p class="text-gray-700 font-medium truncate">{{ \Carbon\Carbon::parse($infant->birth_date)->format('M d, Y') }}</p>
                                    </div>
                                </div>
                            </div>
                ...
                @else
                    ...
                    <div class="px-5 py-14 sm:px-6 sm:py-16">
                        <div class="flex flex-col items-center justify-center text-center">
                            ...
                            <h3 class="mt-5 sm:mt-6 text-lg sm:text-xl font-semibold text-gray-900">No Infant Records Found</h3>
                            <p class="mt-2 max-w-md text-sm leading-6 text-gray-500">
                                No infant healthcare records match the current search criteria or selected filters.
                                Try adjusting the search keyword or infant sex filter to display available infant records.
                            </p>
