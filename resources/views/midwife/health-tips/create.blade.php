                ...
                <div class="relative flex items-start gap-4">
                    ...
                    <div class="min-w-0">
                        ...
                        <p class="mt-3 max-w-2xl text-sm leading-6 text-gray-500">
                            Create a health education article that mothers can read from the CareCradle Health Tips Library.
                        </p>
                    </div>
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <div class="min-w-0">
                            ...
                            <p class="mt-0.5 text-xs sm:text-sm text-gray-500">
                                Fill in the article title, category, and content below.
                            </p>
                        </div>
                    </div>
                </div>

                <form action="{{ route('midwife.health-tips.store') }}" method="POST" enctype="multipart/form-data" class="p-5 sm:p-8">
                    ...
                    <div class="grid grid-cols-1 gap-5 sm:gap-6 md:grid-cols-2">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <label
                                ...
                                <div>
                                    <p class="text-sm font-semibold text-gray-700">Click to upload an image</p>
